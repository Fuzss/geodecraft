...
public class EchoCrystalSpikeFeature extends Feature<GeodeCrystalSpikeConfig> {
    ...
    public boolean place(@NotNull FeaturePlaceContext<GeodeCrystalSpikeConfig> context) {
        ...
        if (world.isStateAtPosition(blockPos.relative(config.crystalDirection().getDirection().getOpposite()),
                ...
                .is(TagRegistry.Blocks.CAN_LARGE_ECHO_CRYSTAL_PLACE) && this.placeSpike(world,
                blockPos,
                radiusCheck,
                stepHeight,
                randomChance,
        ...
        while (true) {
            ...
            for (int var11 = 0; var11 < var10; ++var11) {
                ...
                if (random.nextBoolean() && world.isStateAtPosition(relative, DripstoneUtils::isEmptyOrWater)
                        && world.getBlockState(pos).is(TagRegistry.Blocks.ECHO_SHARD_CRYSTAL_SPIKE_BASE)) {
            ...
            for (int z = -radius; z <= radius; ++z) {
                for (int y = -height; y <= height; ++y) {
                    ...
                    for (int var14 = 0; var14 < var13; ++var14) {
                        ...
                        if (world.getBlockState(pos).is(TagRegistry.Blocks.CAN_LARGE_ECHO_CRYSTAL_PLACE)
