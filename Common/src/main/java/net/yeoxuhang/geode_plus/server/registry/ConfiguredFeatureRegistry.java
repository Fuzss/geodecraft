...
public class ConfiguredFeatureRegistry {
    ...
    public static void bootstrap(BootstrapContext<ConfiguredFeature<?, ?>> context) {
        register(context,
                ...
                new GeodeCrystalSpikeConfig((QUARTZ_CRYSTAL_BLOCK.value()).defaultBlockState(),
                        (QUARTZ_CRYSTAL.value()).defaultBlockState(),
                        UniformInt.of(1, 3),
                        CaveSurface.CEILING));
        register(context,
                CRYSTAL_SPIKE_FLOOR,
        ...
        register(context,
                ...
                new GeodeConfiguration(new GeodeBlockSettings(simple(Blocks.AIR),
                        ...
                        simple(Blocks.NETHERRACK),
                        simple(Blocks.NETHERRACK),
                        List.of(SMALL_QUARTZ_BUD.value().defaultBlockState(),
                                MEDIUM_QUARTZ_BUD.value().defaultBlockState(),
                                LARGE_QUARTZ_BUD.value().defaultBlockState(),
                                QUARTZ_CRYSTAL.value().defaultBlockState()),
                        TagRegistry.Blocks.GEODES_CANNOT_REPLACE,
                        TagRegistry.Blocks.GEODE_INVALID_BLOCKS),
                        new GeodeLayerSettings(1.7D, 2.2D, 3.2D, 4.2D),
        ...
        register(context,
                ...
                new GeodeConfiguration(new GeodeBlockSettings(simple(Blocks.AIR),
                        simple(Blocks.NETHERRACK),
                        simple(BUDDING_BASALT_QUARTZ.value()),
                        simple(Blocks.NETHERRACK),
                        simple(Blocks.NETHERRACK),
                        List.of(SMALL_QUARTZ_BUD.value().defaultBlockState(),
                                MEDIUM_QUARTZ_BUD.value().defaultBlockState(),
        ...
        register(context,
                ...
                new GeodeConfiguration(new GeodeBlockSettings(simple(Blocks.AIR),
                        simple(Blocks.NETHERRACK),
                        simple(BUDDING_BLACKSTONE_QUARTZ.value()),
                        simple(Blocks.NETHERRACK),
                        simple(Blocks.NETHERRACK),
                        List.of(SMALL_QUARTZ_BUD.value().defaultBlockState(),
                                MEDIUM_QUARTZ_BUD.value().defaultBlockState(),
