...
public class BuddingPrismarineBlock extends AmethystBlock {
    ...
    public void randomTick(BlockState p_220898_, ServerLevel p_220899_, BlockPos p_220900_, RandomSource p_220901_) {
        if (p_220901_.nextInt(10) == 0) {
            ...
            } else if (blockstate.is(BlockRegistry.SMALL_PRISMARINE_BUD.value())
            ...
            } else if (blockstate.is(BlockRegistry.MEDIUM_PRISMARINE_BUD.value())
                    && blockstate.getValue(AmethystClusterBlock.FACING) == direction) {
                block = BlockRegistry.LARGE_PRISMARINE_BUD.value();
                applyConduitPowerAround(p_220899_, Vec3.atCenterOf(p_220900_), null, 15);
            } else if (blockstate.is(BlockRegistry.LARGE_PRISMARINE_BUD.value())
                    && blockstate.getValue(AmethystClusterBlock.FACING) == direction) {
