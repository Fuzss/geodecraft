...
public class WrappistPedestalBlock extends BaseEntityBlock {
    public static final List<BlockPos> Wrappist_OFFSETS = BlockPos.betweenClosedStream(-2, 0, -2, 2, 1, 2)
            ...
            if (!wrappistPedestalBlock.isEmpty()) {
                while (var5.hasNext()) {
                    ...
                    if ($$3.nextInt(16) == 0 && isValidWrappistBlock($$1, $$2, $$4)) {
                        $$1.addParticle(ParticleTypes.ENCHANT,
                                (double) $$2.getX() + 0.5,
                                (double) $$2.getY() + 2.0,
                                (double) $$2.getZ() + 0.5,
                                (double) ((float) $$4.getX() + $$3.nextFloat()) - 0.5,
                                (float) $$4.getY() - $$3.nextFloat() - 1.0F,
