...
public class ModBiomeTagsProvider extends AbstractTagProvider<Biome> {
    ...
    public void addTags(HolderLookup.Provider context) {
        // Geodes
        this.tag(TagRegistry.Biomes.HAS_CELESTITE_GEODE).addKey(Biomes.SWAMP, Biomes.MANGROVE_SWAMP);
        this.tag(TagRegistry.Biomes.HAS_PINK_TOPAZ_GEODE).addKey(Biomes.CHERRY_GROVE);
        ...
        this.tag(TagRegistry.Biomes.HAS_NETHER_QUARTZ_GEODE)
                .addKey(Biomes.NETHER_WASTES, Biomes.CRIMSON_FOREST, Biomes.WARPED_FOREST, Biomes.SOUL_SAND_VALLEY);
        ...
        this.tag(TagRegistry.Biomes.HAS_NETHER_ANCIENT_DEBRIS_GEODE)
                .addKey(Biomes.NETHER_WASTES, Biomes.CRIMSON_FOREST, Biomes.WARPED_FOREST, Biomes.SOUL_SAND_VALLEY);
        this.tag(TagRegistry.Biomes.HAS_BASALT_QUARTZ_GEODE).addKey(Biomes.BASALT_DELTAS);
        this.tag(TagRegistry.Biomes.HAS_BASALT_GLOWSTONE_GEODE).addKey(Biomes.BASALT_DELTAS);
        this.tag(TagRegistry.Biomes.HAS_BASALT_GOLD_NUGGET_GEODE).addKey(Biomes.BASALT_DELTAS);
        this.tag(TagRegistry.Biomes.HAS_BASALT_ANCIENT_DEBRIS_GEODE).addKey(Biomes.BASALT_DELTAS);
        this.tag(TagRegistry.Biomes.HAS_WRAPPIST_GEODE).addKey(Biomes.END_HIGHLANDS, Biomes.END_MIDLANDS);
        // Crystals
        ...
        this.tag(TagRegistry.Biomes.HAS_GLOWSTONE_CRYSTAL)
                .addKey(Biomes.NETHER_WASTES, Biomes.CRIMSON_FOREST, Biomes.WARPED_FOREST, Biomes.SOUL_SAND_VALLEY);
        this.tag(TagRegistry.Biomes.HAS_WRAPPIST_CRYSTAL).addKey(Biomes.END_HIGHLANDS, Biomes.END_MIDLANDS);
